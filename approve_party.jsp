...
<div id="content">
   <div id="leftcontent">
 <ul >
 <li><li><a href="create_userid.jsp"><u>Create UserId</u></a>
...
<table border="1">
<tr><th>Party Id</th><th>Party Name</th><th>Action</th>
...
try
{
	...
	ResultSet rs=st.executeQuery("select * from dv_party where party_status='false'");
	while(rs.next())
	{
		
		%>
	<tr><td><%=rs.getInt(1)%></td><td><%=rs.getString(2)%></td><td><a href="approve_party_db.jsp?partyname=<%=rs.getString(2)%>">Approve</td></tr>		
<%
	}
	con.close();
