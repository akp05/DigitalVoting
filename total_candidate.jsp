...
<table border="1">
<tr><th>Candidate Id</th><th>Candidate Name</th><th>Candidate Status</th>
...
try
{
	...
	ResultSet rs=st.executeQuery("select * from dv_candidate");
	while(rs.next())
	{
		
		%>
	<tr><td><%=rs.getInt(1)%></td><td><%=rs.getString(2)%></td><td><%=rs.getString(5)%></td></tr>		
<%
	}
	con.close();
